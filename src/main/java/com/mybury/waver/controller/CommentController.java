...
import com.mybury.waver.dto.comment.CommentUpdateRequest;
...
public class CommentController {
  ...
  @PostMapping
  public void commentCreate(@Parameter(hidden = true) @UserId Long userId, @Valid @RequestBody CommentCreateRequest request) {
